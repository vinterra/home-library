...
//		items.addAll(fillAquaMapsItems(destinationFolder,1));
	 ...
	 * @see org.gcube.portlets.user.homelibrary.testdata.manager.ImageDataManager#fillAllImageDocuments(org.gcube.portlets.user.homelibrary.home.workspace.folder.WorkspaceFolder)
	 */
	 ...
	 * @throws InternalErrorException if an error occurs.
	 * @see org.gcube.portlets.user.homelibrary.testdata.manager.ImageDataManager#fillExternalImages(org.gcube.portlets.user.homelibrary.home.workspace.folder.WorkspaceFolder, int)
	 */
	 ...
	 * @return the generated ExternalImage.
	 * @throws InternalErrorException if an error occurs.
	 * @see org.gcube.portlets.user.homelibrary.testdata.manager.ImageDataManager#fillAllExternalImages(org.gcube.portlets.user.homelibrary.home.workspace.folder.WorkspaceFolder)
	 */
	 ...
	 * @return the generated ImageDocuments.
	 * @throws InternalErrorException if an error occurs.
	 * @see org.gcube.portlets.user.homelibrary.testdata.manager.ImageDataManager#fillImageDocuments(org.gcube.portlets.user.homelibrary.home.workspace.folder.WorkspaceFolder, int)
	 */
	 ...
	 * @see org.gcube.portlets.user.homelibrary.testdata.manager.ImageDataManager#getRandomImageInputStream()
	 */
	 ...
	 * @throws InternalErrorException if an error occurs.
	 * @see org.gcube.portlets.user.homelibrary.testdata.manager.ImageDataManager#getTMPRandomImageFile()
	 */
